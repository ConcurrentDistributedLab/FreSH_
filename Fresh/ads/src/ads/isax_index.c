...
isax_index_settings * isax_index_settings_init(const char * root_directory, int timeseries_size,
                                               ...
                                               int number_of_fail_threads, unsigned int duration_of_fail_thread,int percentage_of_fail_thread,int fail_once, 
                                               int fail_summarization,
                                               int fail_tree_construction,
                                               int fail_query_answering, int fail_helper, int helpers)
{
    int i;
    ...
    //Added by geopat for failure simulation
    settings->number_of_fail_threads = number_of_fail_threads;
    settings->duration_of_fail_thread = duration_of_fail_thread;
    settings->percentage_of_fail_thread = percentage_of_fail_thread;
    settings->fail_once = fail_once;
    settings->fail_summarization = fail_summarization;
    settings->fail_tree_construction = fail_tree_construction;
    settings->fail_query_answering =  fail_query_answering;
    settings->fail_helper = fail_helper;
...
{
    if(!node) {                 // EKOSMAS: ADDED - 23/08/2022
        return;
    }
