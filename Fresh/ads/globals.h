...
#include "config.h"
  ...
  ///// BENCHMARKING /////
        ...
        struct timeval initialize_fbl_time_start;
        // --------------------------------------
        ...
        unsigned long subtrees_pruned_helped;
        unsigned long subtrees_pruned_help_avoided;
        
        double fill_rec_bufs_time;
        // unsigned long fill_rec_bufs_time_flag_start;
        unsigned long fill_rec_bufs_time_flag_end;
        double create_tree_index_time;
        // unsigned long create_tree_index_time_flag_start;
        unsigned long create_tree_index_time_flag_end;
        double query_answering_time;
        // unsigned long query_answering_time_flag_start;
        unsigned long query_answering_time_flag_end;
        ...
        #define INIT_STATS() total_input_time = 0;\
                             ...
                             subtrees_pruned_helped=0;\
                             subtrees_pruned_help_avoided=0;\
                             fill_rec_bufs_time=0;\
                             initialize_fbl_time=0;\
                             // fill_rec_bufs_time_flag_start=0;\
                             fill_rec_bufs_time_flag_end=0;\
                             create_tree_index_time=0;\
                             // create_tree_index_time_flag_start=0;\
                             create_tree_index_time_flag_end=0;\
                             query_answering_time=0;\
                             // query_answering_time_flag_start=0;\
        ...
        #define PRINT_QUERY_STATS(result_distance) printf("%d\t %d\t %ld\t %d\t %lld\t %lf\t %lf\t %lu\t %lu\t %lu\t\n", \
        total_tree_nodes, checked_nodes, \
        ...
        #define MY_PRINT_STATS(result_distance) printf("%lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t  %lu\t %lu\t %lu\t %lu\t %lu\t %lu\t %ld\t %ld\t %ld\t %ld\t %ld\t %ld\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lu\t %lu\t %lu\t\n", \
        total_input_time, total_output_time, \
        total_time, initialize_fbl_time,fill_rec_bufs_time-initialize_fbl_time, create_tree_index_time, query_answering_time, \
        blocks_helped, block_help_avoided, subtrees_helped, subtree_help_avoided, subtrees_pruned_helped, subtrees_pruned_help_avoided, \
        ...
        #define PRINT_STATS_TO_FILE(result_distance, fp) fprintf(fp, "%lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lu\t %lu\t %lu\t %lu\t %lu\t %lu\t %ld\t %ld\t %ld\t %ld\t %ld\t %ld\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lu\t %lu\t %lu\t\n", \
        total_input_time, total_output_time, \
        total_time, initialize_fbl_time,fill_rec_bufs_time-initialize_fbl_time, create_tree_index_time, query_answering_time, \
        blocks_helped, block_help_avoided, subtrees_helped, subtree_help_avoided, subtrees_pruned_helped, subtrees_pruned_help_avoided, \
        ts_in_RecBufs_cnt, ts_in_RecBufs_cnt-dataset_size, ts_in_tree_cnt-ts_in_RecBufs_cnt, \
        ...
        #define COUNT_SUBTREES_PRUNED_HELPED(num) __sync_fetch_and_add(&subtrees_pruned_helped, num);
        #define COUNT_SUBTREES_PRUNED_HELP_AVOIDED(num) __sync_fetch_and_add(&subtrees_pruned_help_avoided, num);
        ...
        #define COUNT_FBL_INITIALIZE_START gettimeofday(&initialize_fbl_time_start, NULL);
        ...
        #define COUNT_FBL_INITIALIZE_TIME_END gettimeofday(&current_time, NULL);  \
                                      tS = initialize_fbl_time_start.tv_sec*1000000 + (initialize_fbl_time_start.tv_usec); \
                                      tE = current_time.tv_sec*1000000 + (current_time.tv_usec); \
                                      initialize_fbl_time += (tE - tS);      
        // -------------------
